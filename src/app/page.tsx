...
export const metadata: Metadata = {
  ...
  description:
    'Главная страница компании Vendista LLC. Наши услуги и преимущества. Продажа электронных компонентов. Производство и поставка. Компания Vendista LLC. Свяжитесь с нами прямо сейчас и получите консультацию по продаже, производству и поставке электронных компонентов.',
  keywords:
